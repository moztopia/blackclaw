...
class DiscoveryApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CollectionListResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CollectionListResponse>> listCollections({ 
    ...
    final _path = r'/v1/games/{gameId}/collections'.replaceAll('{' r'gameId' '}', gameId.toString());
    ...
    CollectionListResponse? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<CollectionListResponse, CollectionListResponse>(rawData, 'CollectionListResponse', growable: true);
